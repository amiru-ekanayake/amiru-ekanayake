...
- 🎓 **InfoSchol Student at Informatics Institute of Technology (IIT, Sri Lanka)  
- 🎓 **G.C.E A/L (2024)** — 3C Passes in Physics Science Stream 
- 🧮 **G.C.E O/L (2021)** — 9A passes including ICT  
- 🌐 **Web Design for Beginners** — CODL, University of Moratuwa[file:2]
- 🗣️ **Intermediate English (CEFR B1)** — British Council Sri Lanka  
...
- **VoiceLink**  
  A voice-focused web experience aimed at improving how users interact and communicate online.

- **Warrantiya (New)**  
  A warranty management web application helping users store and track product warranties efficiently.

- **elift-landing 1**  
  A modern landing page focusing on clean layout, responsive design, and clear product communication.
